  ...
  const blogPosts = [
    {
      ...
      description:
        "From budgeting to paperwork – everything a first-time renter in India should be ready for.",
    ...
    },
    {
      ...
      description:
        "Learn how to evaluate rental listings and avoid overpriced or misleading deals.",
    ...
    },
    {
      ...
      description:
        "Understand your legal rights and obligations as a renter to avoid disputes.",
    ...
    },
    {
      ...
      description:
        "Breakdown of key clauses in rental agreements that every tenant should be aware of.",
    ...
    },
    {
      ...
      description:
        "Explore budget-friendly localities with good amenities in top Indian cities.",
    ...
    },
    {
      ...
      description:
        "Compare costs, convenience, and flexibility to choose the right rental type.",
    ...
    },
    {
      ...
      description:
        "Pro tips to help you get a better deal without scaring off the landlord.",
            ...
            <div className="md:flex">
              ...
              <div className="md:w-1/2 p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-6">
                  From budgeting basics to lease agreements, here's your
                  essential guide to confidently step into your first rental.
                </p>
